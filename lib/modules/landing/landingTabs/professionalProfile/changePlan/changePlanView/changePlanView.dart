...
class ChangePlanView extends StatefulWidget {
  @override
  _ChangePlanViewState createState() => _ChangePlanViewState();
}

class _ChangePlanViewState extends State<ChangePlanView> {
  final ChangePlanController changePlanController = Get.put(
                            ...
                            options: CarouselOptions(
                              ...
                              onPageChanged: (index, reason) {
                                setState(() {
                                  ...
                                  changePlanController.selectPackage(
                                    packages[index].id!,
                                  );
                                });
                              },
                      ...
                      child: AppButton(
                        ...
                        onTap: () async {
                          if (changePlanController
                              ...
                              .isNotEmpty) {
                            print(
                              "Selected Package ID: ${changePlanController.selectedPackageId.value}",
                            );
