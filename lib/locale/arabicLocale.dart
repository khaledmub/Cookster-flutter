const Map<String, String> ar = {
  ...
  "near_me_geo_fallback_notice":
      "تعذر تحديد موقع GPS. فعّل الموقع أو تصفح دولة أخرى.",
  ...
  "browse_another_country": "تصفح دولة أخرى",
  "near_me_no_videos_in_country":
      "لا توجد فيديوهات بالقرب منك في @place. تصفح دولة أخرى لمواصلة المشاهدة.",
  ...
  "compressing_video": "جارٍ ضغط الفيديو...",
  ...
  "upload_error_generic": "حدث خطأ أثناء رفع الفيديو. حاول مرة أخرى.",
  "video_too_large_error": "حجم الفيديو أكبر من 250MB (الحد المسموح). يرجى اختيار فيديو أصغر.",
  "upload_timeout_error": "انتهت مهلة الرفع. تحقق من اتصالك بالإنترنت وحاول مرة أخرى.",
  ...
  "username_required_error": "يرجى اختيار اسم مستخدم.",
  ...
  "users" : "المستخدمون",
  "food" : "طعام",
  "reward_qr": "رمز المكافأة",
  "reward_qr_title": "رمز المكافأة",
  "reward_qr_hint": "اعرض هذا الرمز للموظف لاستلام العنصر المجاني. يتم تحديثه تلقائياً.",
  "reward_qr_refresh_hint": "ينتهي هذا الرمز خلال دقيقة تقريباً.",
  "reward_qr_unavailable": "رمز المكافأة غير متاح حالياً.",
  "partner_rewards": "مكافآت الشريك",
  "reward_create_title": "إنشاء عرض مكافأة",
  "reward_renew_title": "تجديد العرض",
  "reward_item_title": "اسم العنصر",
  "reward_quantity": "الكمية",
  "reward_create": "إنشاء العرض",
  "reward_renew": "تجديد العرض",
  "reward_created": "تم إنشاء العرض",
  "reward_renewed": "تم تجديد العرض",
  "reward_pause": "إيقاف العرض",
  "reward_pause_title": "إيقاف العرض؟",
  "reward_pause_confirm": "لن يتمكن العملاء من الاسترداد حتى التجديد.",
  ...
  "reward_history": "العروض السابقة",
  "reward_status_exhausted": "انتهى هذا العرض. جدّده لبدء عرض جديد.",
  "reward_status_paused": "هذا العرض متوقف. جدّده لبدء عرض جديد.",
  "reward_form_invalid": "أدخل اسم العنصر وكمية لا تقل عن 1.",
  "reward_camera_denied": "يلزم الوصول إلى الكاميرا لمسح رموز المكافأة.",
  "reward_open_settings": "فتح الإعدادات",
  "reward_error_generic": "حدث خطأ. حاول مرة أخرى.",
  "reward_error_already_redeemed": "هذا العميل استرد هذا العرض مسبقاً.",
  "reward_error_deal_exhausted": "لا توجد عناصر متبقية في هذا العرض.",
  "reward_error_deal_paused": "هذا العرض متوقف.",
  "reward_error_no_active_deal": "لا يوجد عرض نشط. أنشئ أو جدّد عرضاً أولاً.",
  "reward_error_invalid_or_expired_token": "الرمز غير صالح أو منتهٍ. اطلب من العميل تحديثه.",
  "reward_error_not_a_partner": "حساب الأعمال فقط يمكنه مسح المكافآت.",
  "reward_error_cannot_redeem_own_qr": "لا يمكنك استرداد رمزك الخاص.",
  "reward_error_active_deal_exists": "لديك عرض نشط بالفعل.",
  "reward_error_partner_blocked": "هذا الشريك محظور من المكافآت.",
  "reward_error_rate_limited": "محاولات مسح كثيرة. انتظر قليلاً."
};
