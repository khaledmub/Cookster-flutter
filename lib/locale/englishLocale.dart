const Map<String, String> en = {
  ...
  "near_me_geo_fallback_notice":
      "We couldn't resolve your GPS location. Enable location or browse another country.",
  ...
  "browse_another_country": "Browse another country",
  "near_me_no_videos_in_country":
      "No videos near you in @place. Browse another country to keep watching.",
  ...
  "upload_error_generic": "An error occurred while uploading. Please try again.",
  "video_too_large_error": "Video is larger than 250MB (allowed limit). Please choose a smaller video.",
  "upload_timeout_error": "Upload timed out. Check your internet connection and try again.",
  ...
  "username_required_error": "Please choose a username.",
  ...
  "food" : "Food",
  "reward_qr": "Reward QR",
  "reward_qr_title": "Your reward QR",
  "reward_qr_hint": "Show this code to staff to claim a free item. It refreshes automatically.",
  "reward_qr_refresh_hint": "This code expires in about a minute.",
  "reward_qr_unavailable": "Your reward QR is not available right now.",
  "partner_rewards": "Partner rewards",
  "reward_create_title": "Create a reward deal",
  "reward_renew_title": "Renew this deal",
  "reward_item_title": "Item name",
  "reward_quantity": "Quantity",
  "reward_create": "Create deal",
  "reward_renew": "Renew deal",
  "reward_created": "Deal created",
  "reward_renewed": "Deal renewed",
  "reward_pause": "Pause deal",
  "reward_pause_title": "Pause deal?",
  "reward_pause_confirm": "Customers will not be able to redeem until you renew.",
  ...
  "reward_history": "Past deals",
  "reward_status_exhausted": "This deal is finished. Renew to start a new one.",
  "reward_status_paused": "This deal is paused. Renew to start a new one.",
  "reward_form_invalid": "Enter an item name and a quantity of at least 1.",
  "reward_camera_denied": "Camera access is required to scan reward QR codes.",
  "reward_open_settings": "Open settings",
  "reward_error_generic": "Something went wrong. Please try again.",
  "reward_error_already_redeemed": "This customer already redeemed this deal.",
  "reward_error_deal_exhausted": "This deal has no items left.",
  "reward_error_deal_paused": "This deal is paused.",
  "reward_error_no_active_deal": "No active deal. Create or renew one first.",
  "reward_error_invalid_or_expired_token": "This QR is invalid or expired. Ask the customer to refresh it.",
  "reward_error_not_a_partner": "Only a business account can scan rewards.",
  "reward_error_cannot_redeem_own_qr": "You cannot redeem your own QR.",
  "reward_error_active_deal_exists": "You already have an active deal.",
  "reward_error_partner_blocked": "This partner is blocked from rewards.",
  "reward_error_rate_limited": "Too many scans. Please wait a moment."
};
